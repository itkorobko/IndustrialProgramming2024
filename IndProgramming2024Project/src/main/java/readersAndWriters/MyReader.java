...
public abstract class MyReader {
	...
	public abstract InputProcessor createMyFileReader(String filename) throws Exception;
	public void readFromFile(String filename,ArrayList<String> lines_with_expression, HashMap<String, String> vars_and_values) throws Exception{
		InputProcessor reader=createMyFileReader(filename);
		reader.processInput(lines_with_expression, vars_and_values);
	}
